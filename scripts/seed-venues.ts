...
const FAYETTEVILLE_VENUES: Venue[] = [
  ...
  // NYE & Entertainment Venues
  {
    id: 'group_therapy_pub',
    name: 'Group Therapy Pub & Playground',
    short_name: 'Group Therapy',
    description: 'Pub and entertainment venue with outdoor games.',
    address: '1906 Skibo Rd',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28314',
    phone: '(910) 429-8111',
    website: 'https://www.grouptherapypub.com',
    venue_type: 'bar',
    google_maps_url: 'https://www.google.com/maps/search/?api=1&query=1906+Skibo+Rd+Fayetteville+NC+28314',
    apple_maps_url: 'https://maps.apple.com/?address=1906+Skibo+Rd,+Fayetteville,+NC+28314',
    aliases: ['Group Therapy Pub & Playground', 'Group Therapy']
  },
  {
    id: 'haymount_truck_stop',
    name: 'Haymount Truck Stop',
    short_name: 'Haymount',
    description: 'Music venue and bar in the Haymount district.',
    address: '100 Broadfoot Ave',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28305',
    venue_type: 'bar',
  ...
  },
  {
    ...
    short_name: "Sol's",
    description: 'Retro arcade bar with craft beer and classic games.',
    address: '421 Maiden Ln',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28301',
    phone: '(910) 797-4442',
  ...
  {
    id: 'north_south_brewing',
    name: 'North South Brewing Company',
    short_name: 'North South',
    description: 'Craft brewery in downtown Fayetteville.',
    address: '304 Williams St',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28301',
    phone: '(910) 223-4111',
    website: 'https://www.northsouthbrewing.com',
    venue_type: 'brewery',
  ...
  },
  {
    ...
    name: 'Club Luna',
    short_name: 'Luna',
    description: 'Nightclub in downtown Fayetteville.',
    address: '200 Hay St',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28301',
    venue_type: 'nightclub',
    google_maps_url: 'https://www.google.com/maps/search/?api=1&query=200+Hay+St+Fayetteville+NC+28301',
    apple_maps_url: 'https://maps.apple.com/?address=200+Hay+St,+Fayetteville,+NC+28301',
    aliases: ['Club Luna', 'Luna']
  },
  {
    id: 'airborne_cigar',
    ...
    zip: '28303',
    phone: '(910) 867-1995',
    website: 'https://airbornecigar.com',
    venue_type: 'bar',
    google_maps_url: 'https://www.google.com/maps/search/?api=1&query=5500+Yadkin+Rd+Fayetteville+NC+28303',
    apple_maps_url: 'https://maps.apple.com/?address=5500+Yadkin+Rd,+Fayetteville,+NC+28303',
    aliases: ['The Airborne Cigar Emporium', 'Airborne Cigar']
  },
  {
    id: 'gates_four',
    name: 'Gates Four Golf and Country Club',
    short_name: 'Gates Four',
    description: 'Private golf and country club.',
    address: '6775 Irongate Dr',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28306',
    phone: '(910) 425-2176',
    website: 'https://www.gatesfour.com',
    venue_type: 'country_club',
    google_maps_url: 'https://www.google.com/maps/search/?api=1&query=6775+Irongate+Dr+Fayetteville+NC+28306',
    apple_maps_url: 'https://maps.apple.com/?address=6775+Irongate+Dr,+Fayetteville,+NC+28306',
    aliases: ['Gates Four Golf and Country Club', 'Gates Four']
  },
  {
    id: 'dragon_lanes',
    name: 'Dragon Lanes',
  ...
  {
    id: 'sirens_lounge',
    name: 'Sirens Flamingo Lounge',
    short_name: 'Sirens Lounge',
    description: 'Elegant lounge inside Anchor Allies featuring craft cocktails and a feminine atmosphere.',
    address: '1204 Bragg Blvd',
    city: 'Fayetteville',
    state: 'NC',
    zip: '28301',
    phone: '(910) 229-3490',
    website: 'https://fayetteville.anchorallies.com',
    venue_type: 'bar',
    google_maps_url: 'https://www.google.com/maps/search/?api=1&query=1204+Bragg+Blvd+Fayetteville+NC+28301',
    apple_maps_url: 'https://maps.apple.com/?address=1204+Bragg+Blvd,+Fayetteville,+NC+28301',
    hours_of_operation: 'Thu-Sat 5:30pm-10:30pm',
    aliases: ['Sirens Flamingo Lounge', 'Sirens Lounge', "Siren's Lounge"]
  },
];
