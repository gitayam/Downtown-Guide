        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
              {/* Column 1: Downtown */}
              <div>
                <p className="text-white/50 text-xs mb-1.5">🏙️ Downtown</p>
                <ul className="space-y-1">
                  ...
                  <li><a href="https://www.fayettevillenc.gov/Parks-and-Recreation/Facilities/Fayetteville-History-Museum" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-dogwood transition-colors">History Museum</a></li>
                  <li><a href="https://www.fayettevillesymphony.org/2025-2026-season/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-dogwood transition-colors">Symphony</a></li>
                  <li><a href="https://cumberland.librarycalendar.com/events/upcoming" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-dogwood transition-colors">HQ Library</a></li>
              ...
              <div>
                ...
                <ul className="space-y-1 mb-3">
                  ...
                  <li><a href="https://fsubroncos.com" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-dogwood transition-colors">FSU Broncos</a></li>
                  <li><a href="https://www.myracepass.com/tracks/2933" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-dogwood transition-colors">Motor Speedway</a></li>
